...
echo "WORDPRESS_ADMIN_USER=danfern3" >> $srcs"/.env"
echo "WORDPRESS_ADMIN_PASSWORD=superInception" >> $srcs"/.env"
echo "WORDPRESS_USER=evaluator" >> $srcs"/.env"
echo "WORDPRESS_PASSWORD=superEvaluator" >> $srcs"/.env"
